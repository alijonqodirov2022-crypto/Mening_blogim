...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-20">
      ...
      <main className="max-w-5xl mx-auto px-6 pt-16">
        <section className="flex flex-col md:flex-row items-center gap-10 mb-24">
          <div className="relative w-40 h-40 shrink-0">
             ...
             <div className="absolute inset-0 bg-slate-300 rounded-[2.5rem] overflow-hidden border-2 border-white shadow-inner">
                <img 
                  src="/me.jpg" 
                  alt="Alijon" 
        ...
        <section id="services" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          ...
          <div className="p-8 bg-blue-600 rounded-[2.5rem] text-white shadow-xl shadow-blue-200 scale-105">
          ...
          <div className="p-8 bg-white rounded-[2.5rem] border-2 border-slate-100 shadow-sm">
            ...
            <h3 className="font-black text-xl mb-2 italic underline decoration-blue-600 text-slate-900">SQL Expert</h3>
        ...
        <section id="contact" className="bg-white rounded-[3.5rem] p-8 md:p-16 border-2 border-slate-900 shadow-2xl relative">
          <div className="max-w-xl mx-auto">
            ...
            <form onSubmit={sendToTelegram} className="flex flex-col gap-4">
              ...
              <textarea placeholder="Qo'shimcha ma'lumot..." value={message} onChange={(e) => setMessage(e.target.value)} className="w-full px-6 py-4 rounded-2xl bg-slate-100 border-none outline-none focus:ring-2 focus:ring-blue-600 h-28" />
      ...
      <footer className="mt-20 text-center text-slate-400 font-bold text-xs uppercase"><p>© 2026 Alidov Portfolio</p></footer>
    </div>
  );
}